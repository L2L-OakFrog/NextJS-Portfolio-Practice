"use client";
import { FaArrowRight, FaCalendarAlt, FaChartLine, FaBookOpen } from "react-icons/fa";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 md:py-16">
        ...
        {featuredPost && (
          <div className="mb-12 sm:mb-16">
            <div className="bg-gradient-to-r from-purple-900/50 to-blue-900/50 rounded-2xl sm:rounded-3xl overflow-hidden shadow-xl sm:shadow-2xl">
                ...
                <div className="p-6 sm:p-8 md:p-10 lg:p-12 flex flex-col justify-center">
                  <div className="flex flex-wrap items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                    ...
                    <span className="text-xs sm:text-sm text-gray-400 flex items-center gap-1">
                      <FaCalendarAlt size={10} className="flex-shrink-0" /> {featuredPost.date}
                    </span>
                  </div>
                  <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold mb-3 sm:mb-4">
                    {featuredPost.title}
                  </h2>
                  <p className="text-sm sm:text-base md:text-lg text-gray-300 mb-4 sm:mb-6">{featuredPost.excerpt}</p>
                  <div className="flex flex-wrap gap-2 sm:gap-4 mb-4 sm:mb-6">
                    {featuredPost.stats.map((stat, index) => (
                  ...
                  <MagicButton
                    ...
                    handleClick={() => navigateToPost(featuredPost.title)}
                  />
                </div>
